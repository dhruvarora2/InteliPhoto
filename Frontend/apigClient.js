...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://nft8rf0kx8.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.searchGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Key1'], ['body']);
        ...
        var searchGetRequest = {
            ...
            queryParams: apiGateway.core.utils.parseParametersToObject(params, ['Key1']),
            body: body
        };
